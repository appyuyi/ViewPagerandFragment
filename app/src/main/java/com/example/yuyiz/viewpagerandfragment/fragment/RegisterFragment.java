...
import com.example.yuyiz.viewpagerandfragment.utils.SMSUtils.SmsCallback;
...
public class RegisterFragment extends Fragment implements OnClickListener {
    ...
    private void init() {
        ...
        etSecond = (EditText) view.findViewById(R.id.et_password);
...
//        smsUtils.setSmsCallback(new SmsCallback() {
//            @Override
...
//注册
    ...
    private void verifyCode() {
        ...
        if (!TextUtils.isEmpty(code)) {
            ...
            //设置Dialog
            verifyDialog = new Dialog(context);
